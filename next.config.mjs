...
const nextConfig = {
  ...
  // Compression
  compress: true,
  // Production source maps (disable for production to reduce size)
  ...
  headers: async () => [
    ...
    {
      // Cache static assets - fixed pattern (no capturing groups)
    ...
    return [
      // Redirect www to non-www
      {
        ...
        has: [
          {
            type: 'host',
            value: 'www.lab68dev.com',
          },
        ],
        destination: 'https://lab68dev.com/:path*',
        permanent: true,
      },
    ]
  },
